...
ggsave(file.path(paperPath,"simGamma_sym_null.tiff"))
ggsave(file.path(paperPath,"simGamma_sym_null.pdf"))
...
ggsave(file.path(paperPath,"simGamma_nonSym_null.tiff"))
ggsave(file.path(paperPath,"simGamma_nonSym_null.pdf"))
